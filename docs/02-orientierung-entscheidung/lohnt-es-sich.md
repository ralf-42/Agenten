...
Diese Seite bewertet deshalb nicht, welches konkrete Werkzeug gewählt werden sollte, sondern ob ein Vorhaben überhaupt tragfähig wirkt. Sie ergänzt damit die spätere Entscheidungsseite [Aufgaben & Lösungswege]({{ '/02-orientierung-entscheidung/aufgabenklassen-und-loesungswege.html' | relative_url }}).
