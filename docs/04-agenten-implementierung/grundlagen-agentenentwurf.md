...
|---|---|---|
| **Welche** Baupläne gibt es? | [Agenten-Architekturen]({{ '/04-agenten-implementierung/agent-architekturen.html' | relative_url }}) | ReAct, Router, Supervisor und grundlegende Agentenmuster. |
