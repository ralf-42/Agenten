...
| **Wie** wird Wissen vorbereitet und angebunden? | [Context Engineering]({{ '/04-agenten-implementierung/context-engineering.html' | relative_url }}), [Tokenizing & Chunking]({{ '/04-agenten-implementierung/tokenizing-chunking.html' | relative_url }}), [Embeddings]({{ '/04-agenten-implementierung/embeddings.html' | relative_url }}) und [RAG-Konzepte]({{ '/04-agenten-implementierung/rag-konzepte.html' | relative_url }}) | Kontextstrategie, Textaufbereitung, Vektoren, Retrieval und Grounding. |
