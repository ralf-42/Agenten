...
| Dokument | Inhalt |
|---|---|
| [LangGraph]({{ '/04-implementierung-frameworks-praxis/einsteiger-langgraph.html' | relative_url }}) | LangGraph aufbauend auf LangChain — Workflows, State, Routing |
| [Einsteiger ChromaDB]({{ '/04-implementierung-frameworks-praxis/einsteiger-chromadb.html' | relative_url }}) | Vektordatenbank für die RAG-Beispiele in diesem Guide |
| [Einsteiger Prompts]({{ '/04-implementierung-frameworks-praxis/einsteiger-prompts.html' | relative_url }}) | Prompt-Dateien und  als Ergänzung zu  |
| [RAG-Konzepte]({{ '/04-implementierung-frameworks-praxis/rag-konzepte.html' | relative_url }}) | Konzeptionelle Grundlagen hinter den RAG-Patterns in Abschnitt 12 |
