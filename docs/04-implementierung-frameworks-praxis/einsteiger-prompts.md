---
layout: default
title: Einsteiger Prompt-Templates
...
Prompts müssen  nicht direkt im Code/Notebook als String hardcodiert werden, sondern können auch als
separate Markdown-Dateien im Ordner `05_prompt/` gespeichert.

**Vorteile:**
- Prompts sind **wiederverwendbar** — einmal schreiben, überall nutzen
- Prompts sind **vom Code getrennt** — Prompt-Anpassungen ohne Code/Notebook-Änderung
...
| Dokument | Inhalt |
|---|---|
| [Einsteiger LangChain]({{ '/04-implementierung-frameworks-praxis/einsteiger-langchain.html' | relative_url }}) |  als Alternative zu Prompt-Dateien |
| [Einsteiger genai_lib]({{ '/04-implementierung-frameworks-praxis/einsteiger-genai-lib.html' | relative_url }}) |  als Ladefunktion für Prompt-Dateien |
| [Einsteiger Agent Builder]({{ '/05-multi-agent-erweiterungen/einsteiger-agent-builder.html' | relative_url }}) | Prompt-Dateien in Agent-Builder-Workflows |
