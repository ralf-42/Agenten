...
| Dokument | Frage |
|---|---|
| [Tokenizing & Chunking]({{ '/04-implementierung-frameworks-praxis/tokenizing-chunking.html' | relative_url }}) | Wie wird Rohtext so vorbereitet, dass Embeddings später sinnvoll berechnet werden können? |
| [RAG-Konzepte]({{ '/04-implementierung-frameworks-praxis/rag-konzepte.html' | relative_url }}) | Wie werden Embeddings praktisch in Retrieval-Systemen genutzt? |
| [Multimodal Bild]({{ '/04-implementierung-frameworks-praxis/tool-use-function-calling.html' | relative_url }}) | Wie werden Vektorähnlichkeiten jenseits von reinem Text relevant? |
