...
| Dokument | Frage |
|---|---|
| [Embeddings]({{ '/04-implementierung-frameworks-praxis/embeddings.html' | relative_url }}) | Wie werden die vorbereiteten Textstücke später semantisch repräsentiert? |
| [RAG-Konzepte]({{ '/04-implementierung-frameworks-praxis/rag-konzepte.html' | relative_url }}) | Wie wirken Chunking-Entscheidungen auf Retrieval und Antwortqualität? |
| [Transformer-Architektur]({{ '/04-implementierung-frameworks-praxis/agent-architekturen.html' | relative_url }}) | Warum spielen Token überhaupt eine so zentrale Rolle für Sprachmodelle? |
