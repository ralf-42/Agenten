...
nav_order: 1
permalink: /07-deployment-capstone/capstone-briefing.html
...
| Dokument | Frage |
|---|---|
| [Erste Agenten]({{ '/04-implementierung-frameworks-praxis/' | relative_url }}) | Wo starte ich als Entwickler mit Capstone-Briefing? |
| [Qualität und Sicherheit]({{ '/06-qualitaet-sicherheit/' | relative_url }}) | Welche Produktionsstandards gelten für Capstone-Briefing? |
