...
- `Agenten/docs/04-implementierung-frameworks-praxis/`
- `Agenten/docs/04-implementierung-frameworks-praxis/`

**Weiterführende Dokumente:**
- [Aufgaben & Lösungswege]({{ '/02-orientierung-entscheidung/aufgabenklassen-und-loesungswege.html' | relative_url }})
- [State Management]({{ '/04-implementierung-frameworks-praxis/state-management.html' | relative_url }})
- [Checkpointing & Persistenz]({{ '/04-implementierung-frameworks-praxis/checkpointing-persistenz.html' | relative_url }})
...
| Dokument | Frage |
|---|---|
| [LangGraph]({{ '/04-implementierung-frameworks-praxis/einsteiger-langgraph.html' | relative_url }}) | Welche LangGraph-Grundlagen braucht der Workshop? |
| [Qualität und Sicherheit]({{ '/06-qualitaet-sicherheit/' | relative_url }}) | Welche Produktionsstandards gelten für Research-Assistant-Projekte? |
