...
| Dokument | Frage |
|---|---|
| [EU AI Act]({{ '/08-regulatorik-verantwortung/eu-ai-act.html' | relative_url }}) | Welche Risikostufen und regulatorischen Pflichten gelten für KI-Systeme? |
...
| [KI-Agenten in regulierten Branchen]({{ '/08-regulatorik-verantwortung/ki-agenten-in-regulierten-branchen.html' | relative_url }}) | Welche zusätzlichen Anforderungen gelten in Medizin, Legal, Finanzwesen und anderen sensiblen Kontexten? |
| [Agenten-Sicherheit]({{ '/06-qualitaet-sicherheit/agent-security.html' | relative_url }}) | Wie werden Tool-Grenzen, Prompt Injection und Datenabfluss technisch begrenzt? |
| [Deployment und Betrieb]({{ '/07-deployment-capstone/' | relative_url }}) | Wie werden Agenten-Systeme betrieben, abgesichert und beobachtet? |
