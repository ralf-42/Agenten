...
> **Welche Anpassungen sind nötig, um die Kurs-Notebooks lokal auszuführen?**<br>
---
...
| Dokument | Frage |
|---|---|
| [Erste Agenten]({{ '/04-implementierung-frameworks-praxis/' | relative_url }}) | Wo starte ich als Entwickler mit Von Colab zu Local? |
| [Qualität und Sicherheit]({{ '/06-qualitaet-sicherheit/' | relative_url }}) | Welche Produktionsstandards gelten für Von Colab zu Local? |
