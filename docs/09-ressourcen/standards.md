...
👉 **[LangChain Guide]({{ '/04-implementierung-frameworks-praxis/einsteiger-langchain.html' | relative_url }})** - Tutorial mit ausführlichen Erklärungen und Mermaid-Diagrammen
...
**Neu in v1.2.0:** Tool Extras und response_format für Agents (siehe LangChain Guide Abschnitte 5.3 und 6.2)
...
- **LangChain Tutorial:** [LangChain Guide]({{ '/04-implementierung-frameworks-praxis/einsteiger-langchain.html' | relative_url }})
- **LangGraph Tutorial:** [LangGraph Guide]({{ '/04-implementierung-frameworks-praxis/einsteiger-langgraph.html' | relative_url }})
- **LangChain Docs:** [python.langchain.com](https://python.langchain.com/)
- **LangGraph Docs:** [langchain-ai.github.io/langgraph](https://langchain-ai.github.io/langgraph/)

---

> 💡 **Tipp:** Für ausführliche LangChain-Beispiele mit Mermaid-Diagrammen siehe [LangChain Guide]({{ '/04-implementierung-frameworks-praxis/einsteiger-langchain.html' | relative_url }})!

## Abgrenzung zu verwandten Dokumenten

| Dokument | Frage |
|---|---|
| [Erste Agenten]({{ '/04-implementierung-frameworks-praxis/' | relative_url }}) | Wo starte ich als Entwickler mit Code Standards? |
| [Qualität und Sicherheit]({{ '/06-qualitaet-sicherheit/' | relative_url }}) | Welche Produktionsstandards gelten für Code Standards? |
