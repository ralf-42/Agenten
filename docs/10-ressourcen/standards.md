...
👉 **[LangChain Guide]({{ '/05-frameworks/einsteiger-langchain.html' | relative_url }})** - Tutorial mit ausführlichen Erklärungen und Mermaid-Diagrammen
...
> 💡 **Tipp:** Für ausführliche LangChain-Beispiele mit Mermaid-Diagrammen siehe [LangChain Guide]({{ '/05-frameworks/einsteiger-langchain.html' | relative_url }})!

## Abgrenzung zu verwandten Dokumenten

| Dokument | Frage |
|---|---|
| [Erste Agenten]({{ '/04-agenten-implementierung/' | relative_url }}) | Wo starte ich als Entwickler mit Code Standards? |
| [Qualität und Sicherheit]({{ '/07-qualitaet-sicherheit/' | relative_url }}) | Welche Produktionsstandards gelten für Code Standards? |
