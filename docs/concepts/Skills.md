...
| Dokument | Frage |
|---|---|
| [Wie werden gute Prompts für Agenten aufgebaut?](./Prompt_Engineering.html) | Wie werden einzelne Anweisungen und System-Prompts wirksam formuliert? |
| [Wie nutzen Agenten Werkzeuge?](./Tool_Use_Function_Calling.html) | Wie werden deterministische Hilfsoperationen eingebunden? |
| [Wie behalten Agenten zwischen Schritten den Überblick?](./State_Management.html) | Wie werden mehrstufige Abläufe kontrolliert ausgeführt? |
| [Wann lohnt sich echte Arbeitsteilung zwischen mehreren Agenten?](./Multi_Agent_Systeme.html) | Wann ist ein eigener Spezialagent sinnvoller als ein Skill? |
