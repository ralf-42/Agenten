...
Wer tiefer in die allgemeine GenAI-Perspektive einsteigen will, findet eine ausführlichere Schwesterseite hier: [Aufgabenklassen & Lösungswege (GenAI)](https://ralf-42.github.io/GenAI/concepts/aufgabenklassen-und-loesungswege.html).
...
| [Modell-Auswahl Guide](../frameworks/modell-auswahl-guide.html) | Welches Modell passt zu welcher Rolle im gewählten System? |
