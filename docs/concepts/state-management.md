...
| Dokument | Frage |
|---|---|
| [Wie bleiben Sitzungen und Zustände erhalten?](./checkpointing-persistenz.html) | Wie wird State über Sitzungen hinweg gespeichert und wiederaufgenommen? |
...
| [Multi-Agent-Systeme](./multi-agent-systeme.html) | Wie wird State zwischen mehreren Rollen oder Knoten eines Systems übergeben? |
