...
> [!TIP] Vorbereitung<br>
> Der [LangGraph Guide]({{ '/orchestrierung/einsteiger-langgraph.html' | relative_url }}) liefert die nötigen Grundlagen für Production-Best-Practices.
...
**Projekt-Ressourcen:**
- [LangGraph Guide]({{ '/orchestrierung/einsteiger-langgraph.html' | relative_url }})
...
| Dokument | Frage |
|---|---|
| [LangGraph]({{ '/orchestrierung/einsteiger-langgraph.html' | relative_url }}) | Welche LangGraph-Grundlagen braucht die Challenge? |
| [Best Practices]({{ '/qualitaet-sicherheit/best-practices.html' | relative_url }}) | Welche Produktionsstandards gelten für Multi-Agent-Projekte? |
