...
| Dokument | Frage |
|---|---|
| [Produktionsreife Anwendung](./aus-entwicklung-ins-{{ '/deployment-capstone/' | relative_url }}) | Wie wird der Übergang vom Jupyter Notebook zur produktionsreifen Anwendung technisch umgesetzt? |
| [Vom Modell zur Anwendung]({{ '/deployment-capstone/vom-modell-zum-produkt-langchain-oekosystem.html' | relative_url }}) | Welche LangChain-Komponenten sind für den Produktionseinsatz relevant? |
| [Agenten-Architekturen]({{ '/erste-agenten/agent-architekturen.html' | relative_url }}) | Welche Architekturpattern gibt es für Agenten auf konzeptioneller Ebene? |
