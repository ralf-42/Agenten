...
### Workshop-Format
- **[Research Assistant Workshop]({{ '/deployment-capstone/research-assistant-workshop.html' | relative_url }})** – *Wie entsteht aus Routing, RAG und Evaluation ein nutzbarer Assistant?* Begleitete Schritt-für-Schritt-Übung
...
### End-to-End Projekt
- **[Agenten Challenge]({{ '/deployment-capstone/agenten-challenges.html' | relative_url }})** – *Wie entwickle ich ein eigenständiges Multi-Agent-System?* Eigenständige Implementierung
