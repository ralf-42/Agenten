...
- `Agenten/docs/orientierung-agentenverstaendnis/`
- `Agenten/docs/tool-use-prompting-erste-agenten/`
- `Agenten/docs/orchestrierung-state-langgraph/`

**Weiterführende Dokumente:**
- [Aufgaben & Lösungswege]({{ '/orientierung-agentenverstaendnis/aufgabenklassen-und-loesungswege.html' | relative_url }})
- [State Management]({{ '/orchestrierung-state-langgraph/state-management.html' | relative_url }})
- [Checkpointing & Persistenz]({{ '/sessions-memory-hitl/checkpointing-persistenz.html' | relative_url }})
...
| Dokument | Frage |
|---|---|
| [LangGraph]({{ '/orchestrierung-state-langgraph/einsteiger-langgraph.html' | relative_url }}) | Welche LangGraph-Grundlagen braucht der Workshop? |
| [Best Practices]({{ '/evaluation-security-reliability/best-practices.html' | relative_url }}) | Welche Produktionsstandards gelten für Research-Assistant-Projekte? |
