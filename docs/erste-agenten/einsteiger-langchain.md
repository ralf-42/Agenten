...
| Dokument | Inhalt |
|---|---|
| [LangGraph]({{ '/orchestrierung/einsteiger-langgraph.html' | relative_url }}) | LangGraph aufbauend auf LangChain — Workflows, State, Routing |
| [Einsteiger ChromaDB]({{ '/rag-kontext/einsteiger-chromadb.html' | relative_url }}) | Vektordatenbank für die RAG-Beispiele in diesem Guide |
| [Einsteiger Prompts]({{ '/erste-agenten/einsteiger-prompts.html' | relative_url }}) | Prompt-Dateien und  als Ergänzung zu  |
| [RAG-Konzepte]({{ '/rag-kontext/rag-konzepte.html' | relative_url }}) | Konzeptionelle Grundlagen hinter den RAG-Patterns in Abschnitt 12 |
