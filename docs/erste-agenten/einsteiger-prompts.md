...
| Dokument | Inhalt |
|---|---|
| [Einsteiger LangChain]({{ '/erste-agenten/einsteiger-langchain.html' | relative_url }}) |  als Alternative zu Prompt-Dateien |
| [Einsteiger genai_lib]({{ '/erste-agenten/einsteiger-genai-lib.html' | relative_url }}) |  als Ladefunktion für Prompt-Dateien |
| [Einsteiger Agent Builder]({{ '/multi-agent/einsteiger-agent-builder.html' | relative_url }}) | Prompt-Dateien in Agent-Builder-Workflows |
