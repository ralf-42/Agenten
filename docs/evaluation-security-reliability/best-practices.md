...
- **[LangChain Best Practices]({{ '/tool-use-prompting-erste-agenten/langchain-best-practices.html' | relative_url }})** – *Was sind die 7 MUST-HAVE Features?* `init_chat_model()`, `with_structured_output()`, `@tool`, `create_agent()`, LCEL `|` Chains, Middleware, Standard Content Blocks.
