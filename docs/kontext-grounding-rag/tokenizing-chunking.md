...
| Dokument | Frage |
|---|---|
| [Embeddings]({{ '/kontext-grounding-rag/embeddings.html' | relative_url }}) | Wie werden die vorbereiteten Textstücke später semantisch repräsentiert? |
| [RAG-Konzepte]({{ '/kontext-grounding-rag/rag-konzepte.html' | relative_url }}) | Wie wirken Chunking-Entscheidungen auf Retrieval und Antwortqualität? |
| [Transformer-Architektur]({{ '/tool-use-prompting-erste-agenten/agent-architekturen.html' | relative_url }}) | Warum spielen Token überhaupt eine so zentrale Rolle für Sprachmodelle? |
