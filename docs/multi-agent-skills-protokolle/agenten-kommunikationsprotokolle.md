...
| Dokument | Frage |
|---|---|
| [Multi-Agent-Systeme]({{ '/multi-agent-skills-protokolle/multi-agent-systeme.html' | relative_url }}) | Wie arbeiten mehrere Agenten organisatorisch zusammen, unabhängig vom konkreten Protokoll? |
| [Agenten-Sicherheit]({{ '/evaluation-security-reliability/agent-security.html' | relative_url }}) | Welche Sicherheitsrisiken entstehen durch offene Schnittstellen, Tool-Zugriffe und externe Agenten? |
| [Skills]({{ '/multi-agent-skills-protokolle/skills.html' | relative_url }}) | Wann reichen lokale, wiederverwendbare Arbeitsrezepte statt offener Protokollschnittstellen? |
