...
| Dokument | Frage |
|---|---|
| [Lohnt sich KI?]({{ '/orientierung/lohnt-es-sich.html' | relative_url }}) | Wann ist ein KI-Vorhaben überhaupt sinnvoll? |
| [Welches Werkzeug?]({{ '/orientierung/aufgabenklassen-und-loesungswege.html' | relative_url }}) | Welcher Lösungsweg passt zur Aufgabe? |
| [Agenten-Architekturen]({{ '/erste-agenten/agent-architekturen.html' | relative_url }}) | Welche Architekturmuster gibt es und wann passen sie? |
