...
| Dokument | Frage |
|---|---|
| [Tokenizing & Chunking]({{ '/rag-kontext/tokenizing-chunking.html' | relative_url }}) | Wie wird Rohtext so vorbereitet, dass Embeddings später sinnvoll berechnet werden können? |
| [RAG-Konzepte]({{ '/rag-kontext/rag-konzepte.html' | relative_url }}) | Wie werden Embeddings praktisch in Retrieval-Systemen genutzt? |
| [Multimodal Bild]({{ '/erste-agenten/tool-use-function-calling.html' | relative_url }}) | Wie werden Vektorähnlichkeiten jenseits von reinem Text relevant? |
