...
Durch die Weiterentwicklung der Website, der Kursmaterialien oder aufgrund geänderter gesetzlicher oder behördlicher Vorgaben kann es notwendig werden, diese Datenschutzerklärung zu ändern. Die jeweils aktuelle Datenschutzerklärung kann jederzeit auf dieser Website unter `{{ '/rechtliches/datenschutz.html' | relative_url }}` abgerufen werden.
