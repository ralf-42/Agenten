...
| Dokument | Frage |
|---|---|
| [EU AI Act]({{ '/regulatorik/eu-ai-act.html' | relative_url }}) | Welche Risikostufen und regulatorischen Pflichten gelten für KI-Systeme? |
...
| [KI-Agenten in regulierten Branchen]({{ '/regulatorik/ki-agenten-in-regulierten-branchen.html' | relative_url }}) | Welche zusätzlichen Anforderungen gelten in Medizin, Legal, Finanzwesen und anderen sensiblen Kontexten? |
| [Agenten-Sicherheit]({{ '/qualitaet-sicherheit/agent-security.html' | relative_url }}) | Wie werden Tool-Grenzen, Prompt Injection und Datenabfluss technisch begrenzt? |
| [Deployment und Betrieb]({{ '/deployment-capstone/' | relative_url }}) | Wie werden Agenten-Systeme betrieben, abgesichert und beobachtet? |
