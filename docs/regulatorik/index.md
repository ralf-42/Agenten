...
- **[Digitale Souveränität]({{ '/regulatorik/digitale-souveraenitaet.html' | relative_url }})** – *Wie unabhängig ist Europa bei der KI-Infrastruktur?* Definition, Reifegrade und europäische Strategien
...
- **[EU AI Act]({{ '/regulatorik/eu-ai-act.html' | relative_url }})** – *Was regelt das KI-Recht in Europa?* Europäische KI-Regulierung
  - Rechtliche Rahmenbedingungen
  - Risikostufen und Anforderungen
  - Compliance-Aspekte
  - Praktische Auswirkungen

- **[Datenschutz & DSGVO]({{ '/regulatorik/datenschutz-dsgvo.html' | relative_url }})** – *Was gilt beim Einsatz von LLM-APIs unter der DSGVO?* Datenschutzkonforme KI-Entwicklung
...
- **[KI-Agenten in regulierten Branchen]({{ '/regulatorik/ki-agenten-in-regulierten-branchen.html' | relative_url }})** – *Was ändert sich für Agenten-Architektur in Medizin, Legal und Finanzwesen?*
...
### Ethik & Verantwortung
- **[Ethik und GenAI]({{ '/regulatorik/ethik-und-genai.html' | relative_url }})** – *Was sind die ethischen Grenzen beim KI-Einsatz?* Verantwortungsvoller KI-Einsatz
