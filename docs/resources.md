...
- **[Interaktive Visualisierungen](./interaktive_visualisierungen.html)** – Web-Demos für KI-Konzepte zum Erkunden und Verstehen
  - Transformer-Architektur, Embeddings und Tokenizer interaktiv
  - Modellsteuerung und Prompt-Effekte live ausprobieren

- **[API-Keys & Provider](./API_Keys_und_Provider.html)** – Übersicht über LLM-Provider, API-Keys und Colab-Integration
...
- **[Code Standards](./standards.html)** – Coding-Konventionen und Best Practices für den Kurs
...
- **[Troubleshooting](./troubleshooting.html)** – Lösungen für häufige Probleme
...
- **[Von Colab zur lokalen Umgebung](./Colab_zu_Lokal.html)** – Anleitung zur Ausführung der Notebooks in Jupyter Lab / VS Code
...
- **[Links](./links.html)** – Kuratierte Sammlung externer Ressourcen zu KI, LLMs und Frameworks
