...
| Dokument | Inhalt |
|---|---|
| [LangGraph]({{ '/orchestrierung-state-langgraph/einsteiger-langgraph.html' | relative_url }}) | LangGraph aufbauend auf LangChain — Workflows, State, Routing |
| [Einsteiger ChromaDB]({{ '/kontext-grounding-rag/einsteiger-chromadb.html' | relative_url }}) | Vektordatenbank für die RAG-Beispiele in diesem Guide |
| [Einsteiger Prompts]({{ '/tool-use-prompting-erste-agenten/einsteiger-prompts.html' | relative_url }}) | Prompt-Dateien und  als Ergänzung zu  |
| [RAG-Konzepte]({{ '/kontext-grounding-rag/rag-konzepte.html' | relative_url }}) | Konzeptionelle Grundlagen hinter den RAG-Patterns in Abschnitt 12 |
